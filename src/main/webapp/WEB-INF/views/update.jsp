 ...
 <div class="container">
      <form class="row was-validated" name="write_form" action="updateok" method="post">
         <div class="col-md-6">
             ...
             value="${update.writer }" required />
             <div class="invalid-feedback">이름을 입력하세요.</div>
         </div>
         <div class="col-md-6">
             <label>비밀번호</label>
             <input type="password" name="userpass" class="form-control" placeholder="비밀번호" required />
         ...
         <div class="col-md-12 mt-5">
             <textarea id="content" name="contents">${update.contents }</textarea>
         </div>
